...
## Travel and reimbursements guide


*Overview*

Traveling to collaborate and share with other colleagues is an integral part of university life. UB offers payment options and will reimburse individuals for reasonable, necessary, appropriate, cost-effective, and approved travel and business expenses incurred in the performance of university business. Before using a specific grant, you should research programs offerred by UB to off-set travel costs as much as possible.


**Using Concur**

The general steps are as follows:
- Submit a travel request in Concur and obtain preapproval before traveling!
- Fill out the request header, with a specific title (e.g. John Doe APS 2025 conference), and business justification (e.g. Attend and present research at APS conference.). Make sure to add account the funds should come from (“startup expenditure funds”; NSF grant xxxxxxxx) in the business justification field.
- Add expenses with your best estimate for the costs.
- Fly out and enjoy the conference. Keep your receipts!
- After you come back from the conference, convert your request to an expense report.
- Add expenses, along with images/copies of the receipts.
- Under 'Manage Receipts', attach to the report a copy of your talk/poster abstract and conference agenda.  
- Under ‘Print/Share’, print or email the detailed report, forwarding a copy of the report to Dr. Yong, ask for approval for the expenses and to confirm the account the expenses should be charged to (e.g. startup expenditure funds).
- Submit the report.
